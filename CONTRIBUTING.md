...
The scope should indicate what is being changed. Generally, these should match component names. For example, `AvatarComponent`, `WebexAdapter`, etc. Other than component names, `tooling` tends to be the most common.
