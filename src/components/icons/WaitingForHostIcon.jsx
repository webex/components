 ...
 *
 */
export default function WaitingForHostIcon({size, className, style}) {
  const [cssClasses] = webexComponentClasses('waiting-for-host-icon', className);

  return (
    <svg width={size} height={size} viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" className={cssClasses} style={style}>
